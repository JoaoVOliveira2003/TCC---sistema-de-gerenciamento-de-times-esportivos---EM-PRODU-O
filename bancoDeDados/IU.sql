...
CREATE TABLE IF NOT EXISTS `tcc`.`estado` (
  ...
  `cod_nacao` SMALLINT NOT NULL,  -- Relacionamento com a tabela 'nacao'
  `desc_estado` VARCHAR(50) NULL,
  `sigla_estado` CHAR(3) NULL,
  PRIMARY KEY (`cod_estado`),  -- Definindo apenas 'cod_estado' como PK
  INDEX `fk_estado_nacao_idx` (`cod_nacao` ASC),
